document.querySelector("form").addEventListener("submit", function (e) {
  ...
  const techIconsHTML = selectedTechs
    .map((input) => {
      const iconSrc = techIconMap[input.value];
      return `<img src="${iconSrc}" alt="${input.value}" title="${input.value}" style="width: 48px; height: 48px; margin-right: 6px;" />`;
    })
    .join("");
    ...
    card.innerHTML = `
          ...
          <div class="card-content">
            ...
            <div class="card-bottom">
              <div class="card-tech">${techIconsHTML}</div>
